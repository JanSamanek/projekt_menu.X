...
void __attribute__((picinterrupt(("")))) UART_TMR1_ISR(void)
{
...
#pragma config PLLCFG = ON
 ...
 PWM_init();
        ...
        case 3:
                ...
                GODONE = 1;
                while(GODONE);
                potenciometer2 = (ADRESH << 8) | ADRESL;
                ...
                value_out = (unsigned long)potenciometer1*(unsigned long)potenciometer2;
                printf("%lu\n",value_out);
        ...
        case 4:
                ...
                while(1){
                    ...
                    {
                        SPIWrite(0b10110000, pot1);
                        j++;
                    }
                    else if((tabulka[j] < pot2) && (tabulka[j] < 128))
                    {
                        SPIWrite(0b10110000, pot2);
                        j++;
                    }
                    else
                    {
                    SPIWrite(0b10110000,tabulka[j++]);
                    }
                    if(j == 128) j=0;
...
#pragma config PLLCFG = ON
 sprintf(text1M, "%s%s           ",cursor, (menu_names+5*position));
                ...
                else if(PORTCbits.RC0 && !(position == 0))
                {
                    _delay((unsigned long)((80)*(32e6/4000.0)));
                    if(PORTCbits.RC0)
                    {
